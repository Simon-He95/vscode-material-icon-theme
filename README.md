<h1 align="center">
  <br>
    <img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/logo.png" alt="logo" width="200">
  <br><br>
  Material Icon Theme
  <br>
  <br>
...
<p align="center">
    <a href="https://marketplace.visualstudio.com/items?itemName=simonhe.material-icon-theme-simon"><img src="https://img.shields.io/visual-studio-marketplace/v/simonhe.material-icon-theme-simon?style=for-the-badge&colorA=252526&colorB=43A047&label=VERSION" alt="Version"></a>&nbsp;
    <a href="https://marketplace.visualstudio.com/items?itemName=simonhe.material-icon-theme-simon"><img src="https://img.shields.io/visual-studio-marketplace/r/simonhe.material-icon-theme-simon?style=for-the-badge&colorA=252526&colorB=43A047&label=Rating" alt="Rating"></a>&nbsp;
    <a href="https://marketplace.visualstudio.com/items?itemName=simonhe.material-icon-theme-simon"><img src="https://img.shields.io/visual-studio-marketplace/i/simonhe.material-icon-theme-simon?style=for-the-badge&colorA=252526&colorB=43A047&label=Installs" alt="Installs"></a>&nbsp;
    <a href="https://marketplace.visualstudio.com/items?itemName=simonhe.material-icon-theme-simon"><img src="https://img.shields.io/visual-studio-marketplace/d/simonhe.material-icon-theme-simon?style=for-the-badge&colorA=252526&colorB=43A047&label=Downloads" alt="Downloads"></a>
</p>
...
<img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/fileIcons.png" alt="file icons">

### Folder icons

<img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/folderIcons.png" alt="folder icons">

#### Customize file & folder color

You can change the color of the default file and folder icons using the command palette:

<img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/set-folder-color.gif" alt="custom folder colors">

or via user settings:

```json
"material-icon-theme-simon.folders.color": "#ef5350",
"material-icon-theme-simon.files.color": "#42a5f5",
```
...
<img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/set-folder-theme.gif" alt="folder themes">

or via user settings:

```json
"material-icon-theme-simon.folders.theme": "specific"
```
...
```json
"material-icon-theme-simon.opacity": 0.5
```
...
```json
"material-icon-theme-simon.saturation": 0.5
```
...
<img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/commandPalette.png" alt="commands">
...
<a href="https://github.com/simonhe/vscode-material-icon-theme-simon/graphs/contributors">
    <img src="https://raw.githubusercontent.com/simonhe/vscode-material-icon-theme-simon/main/images/contributors.png" alt="Contributors">
</a>

**Would you like to contribute?**

Take a look at the [contribution guidelines](https://github.com/simonhe/vscode-material-icon-theme-simon/blob/main/CONTRIBUTING.md) and open a [new issue](https://github.com/simonhe/vscode-material-icon-theme-simon/issues) or [pull request](https://github.com/simonhe/vscode-material-icon-theme-simon/pulls) on GitHub.
